...
class Servidor:
    ...
    def abrir_conexao(self, id_conexao, segment):
    ...
    def _rdt_rcv(self, src_addr, dst_addr, segment):
        ...
        if (flags & FLAGS_SYN) == FLAGS_SYN:
            ...
            conexao = self.conexoes[id_conexao] = self.abrir_conexao(id_conexao, segment)
...
class Conexao:
    ...
    def _retransmit(self):
        ...
        self._enviar_segmento_ack(data)

    def _enviar_segmento_ack(self, data):
        seq_no = None
    ...
    def _enviar_pendente(self):
        ...
        if size_pending > 0:
            ...
            for i in range(n_segment):
                ...
                self._enviar_segmento_ack(segment)
